...
from ..backend.backend import Statics
...
def stats_cards_group() -> rx.Component:
    return rx.hstack(
        stats_card(
            "Novedades bancarias",
            Statics.total_novedades,
            Statics.novedades_semanal,
            "landmark",
            "blue",
            "Eventos acumulados",
        ),
        ...
        stats_card2(
            "Procesos pendientes",
            Statics.total_novedades_pendientes,
            Statics.novedades_semanal,
            "notebook-pen",
            "orange",
            "Eventos acumulados",
        ...
        stats_card(
            "Retrasos y Quejas",
            Statics.total_quejas_novedades,
            Statics.quejas_semanal_novedades,
            "calendar-x-2",
            "ruby",
            "Eventos acumulados",
        ),
